...
let colisaoDireita, colisaoEsquerda, colisaoCima, colisaoBaixo;
function colidirParedes(){
  ...
  colisaoBaixo = collideRectRect(cobraX, cobraY, cobraW, cobraH, posXParB, posYParB, WParCB, HParCB);

  //console.log(colisaoDireita, colisaoEsquerda, colisaoCima, colisaoBaixo);

  if(colisaoCima == true || colisaoBaixo == true || colisaoDireita == true || colisaoEsquerda == true){
    cobraX = 200;
    cobraY = 200;
    partes = 0;
    rabo = [];
...
function pontos(){
  document.querySelector("#pontos").innerHTML = " Pontos: "+ponto;
}